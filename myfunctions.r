...
## q <- "select model_species, count(*), st_collect(start_point) from all_captures
## where fishing_year = '2011/2012'
## group by model_species
## "
## system(sprintf('ogr2ogr -f "ESRI Shapefile" /home/yvan/test_ogr.shp PG:"host=titi port=5433 dbname=oreo-2013v1" -sql "%s"', q))
