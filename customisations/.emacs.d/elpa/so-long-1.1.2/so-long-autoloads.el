...
If called interactively, enable So-Long minor mode if ARG is positive, and disable it if
ARG is zero or negative.  If called from Lisp, also enable the mode if ARG is omitted or
nil, and toggle it if ARG is `toggle'; disable the mode otherwise.
...
If called interactively, enable Global So-Long mode if ARG is positive, and disable it if
ARG is zero or negative.  If called from Lisp, also enable the mode if ARG is omitted or
nil, and toggle it if ARG is `toggle'; disable the mode otherwise.
...
;;;***

;;;### (autoloads nil nil ("so-long-pkg.el") (0 0 0 0))
